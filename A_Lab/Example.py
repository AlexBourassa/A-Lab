...
This file contains is used mainly as a test bed for the overall application.  You can find more specific applications
in A_Lab/Apps
...
# Attempt to make this work with both pyside and pyQt (it works but the added complications
# wasn't worth it...)
